...
function dec_Int($) { return { v: $ - 1 }; }
function inc_Int($) { return { v: $ + 1 }; }

function add_Int($) { return { v: $["0"] + $["1"] }; }
function sub_Int($) { return { v: $["0"] - $["1"] }; }
function mul_Int($) { return { v: $["0"] * $["1"] }; }
function div_Int($) { return { v: $["0"] / $["1"] }; }
...
function rem_Int($) { return { v: $["0"] % $["1"] }; }

function eq_Int($) { return { v: $["0"] == $["1"] }; }
function ne_Int($) { return { v: $["0"] != $["1"] }; }
function ge_Int($) { return { v: $["0"] >= $["1"] }; }
function gt_Int($) { return { v: $["0"] >  $["1"] }; }
function le_Int($) { return { v: $["0"] <= $["1"] }; }
function lt_Int($) { return { v: $["0"] <  $["1"] }; }
